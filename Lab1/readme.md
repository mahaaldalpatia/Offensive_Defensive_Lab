...
![Nmap Service Scan](screenshots/01.png)

### 2. Network Configuration

![Network Configuration](screenshots/02.png)

### 3. Ping Connectivity Test

![Ping Connectivity Test](screenshots/03.png)

### 4. Nmap OS and Service Detection

![Nmap OS Scan](screenshots/04.png)

### 5. Nessus Vulnerability Scan Results

![Nessus Results](screenshots/05.png)
